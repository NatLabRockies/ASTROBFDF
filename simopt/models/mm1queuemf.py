...
class MM1QueueMF(Model):
    ...
    def replicate(self, rng_list):
        ...
        mean_sojourn_time_lf = np.mean(cust_mat[self.factors["warmup"]:lf_t, 3])
        #mean_sojourn_time_lf = np.mean(cust_mat[:self.factors["warmup"], 3])
        ...
        responses = {
            ...
            "avg_sojourn_time_lf": mean_sojourn_time_lf,
...
class MM1MinMeanSojournTimeMF(Problem):
    """
    ...
    base.Problem
    """
    def __init__(self, name="MM1MF-1", fixed_factors=None, model_fixed_factors=None):
        if fixed_factors is None:
            fixed_factors = {}
        ...
        self.model = MM1QueueMF(self.model_fixed_factors)
    ...
    def response_dict_to_lf_f(self, response_dict):
        ...
        objectives : tuple
            vector of objectives
        """
        lf_f = (response_dict["avg_sojourn_time_lf"],)
        return lf_f
    ...
    def get_random_solution(self, rand_sol_rng):
        ...
        x = (rand_sol_rng.expovariate(10)/1.5,)
        return x
