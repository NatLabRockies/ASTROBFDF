...
# SOLVERS
# Use the following solvers (line 21) for Figure 15(a)
#solvers = ["ADAM_lr=0.01_n=10", "ADAM_lr=0.1_n=10", "ADAM_lr=0.5_n=10", "ADAM_lr=1_n=10",  "ADAM_lr=2.0_n=10"]
# Use the following solvers (line 23) for Figure 15(b)
#solvers = ["ADAM_lr=1_n=10", "ADAM_lr=1_n=20", "ADAM_lr=1_n=30"]
# Use the following solvers (line 25) for Figure 15(c)
#solvers = ["BFSAG_lr=0.01_n=10", "BFSAG_lr=0.1_n=10", "BFSAG_lr=0.5_n=10", "BFSAG_lr=1_n=10",  "BFSAG_lr=2.0_n=10"]
# Use the following solvers (line 27) for Figure 15(d)
solvers = ["BFSAG_lr=0.01_n=10", "BFSAG_lr=0.01_n=20", "BFSAG_lr=0.01_n=30"]
