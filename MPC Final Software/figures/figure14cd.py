...
# SOLVERS
# Use the following solvers (line 25) for Figure 14(c)
#solvers = ["ASTROBFDF_coef=0.5", "ASTROBFDF_coef=1", "ASTROBFDF_coef=1.5", "ASTROBFDF_coef=2.0"] # Figure 14(c)
# Use the following solvers (line 27) for Figure 14(d)
solvers = ["ASTRODF_coef=0.5", "ASTRODF_coef=1", "ASTRODF_coef=1.5", "ASTRODF_coef=2.0"] # Figure 14(d)
