...
# SOLVERS
# Use the following solvers (line 25) for Figure 16(a)
solvers = ["ADAM_coef=0.5_n=10", "ADAM_coef=1_n=10", "ADAM_coef=1.5_n=10", "ADAM_coef=2.0_n=10"] # Figure 16(a)
# Use the following solvers (line 27) for Figure 16(b)
#solvers = ["ADAM_coef=2.0_n=10","ADAM_coef=2.0_n=20","ADAM_coef=2.0_n=30"] # Figure 16(b)
# Use the following solvers (line 29) for Figure 16(c)
#solvers = ["BFSAG_coef=0.5_n=10", "BFSAG_coef=1_n=10", "BFSAG_coef=1.5_n=10", "BFSAG_coef=2.0_n=10"] # Figure 16(c)
# Use the following solvers (line 31) for Figure 16(d)
#solvers = ["BFSAG_coef=2.0_n=10","BFSAG_coef=2.0_n=20","BFSAG_coef=2.0_n=30"] # Figure 16(d)
...
for solver in solvers:
    ...
    if solver == "ADAM_coef=0.5_n=10":
        solver_display = r"ADAM_$c_\Delta$=0.5_n=10"
    elif solver == "ADAM_coef=1_n=10":
        solver_display = r"ADAM_$c_\Delta$=1.0_n=10"
    elif solver == "ADAM_coef=1.5_n=10":
        solver_display = r"ADAM_$c_\Delta$=1.5_n=10"
    elif solver == "ADAM_coef=2.0_n=10":
        solver_display = r"ADAM_$c_\Delta$=2.0_n=10"
    elif solver == "ADAM_coef=2.0_n=20":
        solver_display = r"ADAM_$c_\Delta$=2.0_n=20"
    elif solver == "ADAM_coef=2.0_n=30":
        solver_display = r"ADAM_$c_\Delta$=2.0_n=30"

    elif solver == "BFSAG_coef=0.5_n=10":
        solver_display = r"BFSAG_$c_\Delta$=0.5_n=10"
    elif solver == "BFSAG_coef=1_n=10":
        solver_display = r"BFSAG_$c_\Delta$=1.0_n=10"
    elif solver == "BFSAG_coef=1.5_n=10":
        solver_display = r"BFSAG_$c_\Delta$=1.5_n=10"
    elif solver == "BFSAG_coef=2.0_n=10":
        solver_display = r"BFSAG_$c_\Delta$=2.0_n=10"
    elif solver == "BFSAG_coef=2.0_n=20":
        solver_display = r"BFSAG_$c_\Delta$=2.0_n=20"
    elif solver == "BFSAG_coef=2.0_n=30":
        solver_display = r"BFSAG_$c_\Delta$=2.0_n=30"
